...
namespace PercobaanApi2.Models
{
    public class PersonContext
    {
        ...
        public List<Mahasiswa> ListPerson()
        {
            List<Mahasiswa> list1 = new List<Mahasiswa>();
        ...
        public void AddPerson(Mahasiswa person)
        {
        ...
        public void UpdatePerson(Mahasiswa person)
        {
